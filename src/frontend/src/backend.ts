...
export class Backend implements backendInterface {
    ...
    async getAllContactFormTexts(): Promise<Array<string>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllContactFormTexts();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getContactFormCount(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getContactFormCount();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
